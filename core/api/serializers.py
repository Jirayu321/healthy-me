...
class UserDetailSerializer(serializers.ModelSerializer):
    profile_user = serializers.SerializerMethodField('get_profile')
    bmi = serializers.SerializerMethodField('cal_bmi')
   
    def get_profile(self, obj):
        data = UserProfile.objects.get(user=obj)
        serializer_class = UserProfileSerializer(data)
