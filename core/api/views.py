...
from .serializers import (
    ...
    PaymentSerializer, UserDetailSerializer
)
...
# Bad Smell Duplicate Permission_Class 
# ใช้รวมได้
...
# Bad Smell Use With APIVIEW RetriveUpdateDestroy
...
# Bad Smell Duplicate Can use UPdateRetriveDestroy
